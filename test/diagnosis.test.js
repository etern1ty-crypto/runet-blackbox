...
const cases = [
  ...
  ["both tcp ports timeout", { tcp_80: { status: "timeout" }, tcp_443: { status: "timeout" } }, "tcp_timeout"],
  ...
  ["tls reset after client hello", { tls: { status: "reset_after_client_hello" } }, "tls_reset"],
  ["tls reset", { tls: { status: "reset" } }, "tls_reset"],
